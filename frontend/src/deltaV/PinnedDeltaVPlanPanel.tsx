...
export function PinnedDeltaVPlanPanel({
  ...
  >
    ...
    {!pinned.craftBound && <>
      ...
      <div className="delta-v-pinned-scope-warning" role="alert">Craft identity is unavailable. Install or repair StageStats 0.2.5, then pin this plan to the intended craft.</div>
    </>}
