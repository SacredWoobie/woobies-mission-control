...
export const flightTelemetryFixture: TelemetrySnapshot = {
  ...
  "damage.parts": [
    { kind: "antenna", name: "RFL-100 Giant Dish Reflector", module: "ModuleDeployableReflector", count: 24 },
    { kind: "radiator", name: "XR-175 High Temperature Heat Radiator", module: "ModuleDeployableRadiator", count: 12 },
  ],
  "damage.checkedKinds": [],
